            ...
            <div class="row">
                <div class="form-group col-sm-4">
                    ...
                    <div class="form-group">
                        <input type="text" name="search" id="search" class="form-control" placeholder="Search Category Data" />
                    </div>
                </div>
            </div>
                            ...
                            <table class="table table-hover table-striped table-condensed table-bordered">
                                ...
                                @foreach($list_category as $item)
                                    <tr>
                                        ...
                                        <td class="none">
                                            <a class="btn btn-info btn-sm" href="/admin/category/{{$item -> id}}/edit"><i class="fas fa-edit"></i> <b>Edit</b></a>
