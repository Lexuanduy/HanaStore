        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-header card-header-text">
                    <h4 class="mb-0"><i class="fab fa-pagelines text-danger"></i> CẬP NHẬT BỘ SƯU TẬP</h4>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 form-group mb-3">
                                            <div class="input-group" {{$errors->has('name')?' has-error':''}}>
                                                ...
                                                <input type="text" name="name" class="form-control" placeholder="Tên gọi" value="{{$collection->name}}" required>
